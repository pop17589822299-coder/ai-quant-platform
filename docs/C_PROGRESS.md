...
**最终复查更新：PR #10 与 PR #12 已由 D 合并，main 为 `5a1247e61e6d3197c427f0cdcfa88d0a24d8c437`；PR #14 尚未合并。生产代码及固定包与 C 已测 bcbd559 相同，原九组/API范围通过；预热脚本仍未含 B a89c2ea 修复，待其实际进入 main 后确认。D 已记录用户最终验收通过、用户代理关闭A页面门禁，非 C 独立页面实测。**
...
| 整体 V2 | PR #10/#12已合并；PR #14仍开放，预热入口仍待集成确认 |
